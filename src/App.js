      ...
      <main>
        ...
        <div className='block2'>
          ...
          <ul className='catalogue'>
            ...
            <a href='/sensor'>
              ...
              <img src={sensor} className='sensorImage' />
            </a>
            <a href='/dj'>
              <p>DJ оборудование</p>
              <img src={dj} />
        ...
        <div className='block3'>
          ...
          <div className='contactIcons'>
            <a href='https://wa.me/089628242222'>
              <img
                src={whatsapp}
                className='contactIcon'
              />
            </a>
            <a href='https://t.me/adigamovrus'>
              <img
                src={telegram}
                className='contactIcon'
              />
        ...
        <div className='block4'>
          <li>
            <img
              src='https://i.pinimg.com/originals/b6/69/77/b66977560ff83f3258674803e0422bbd.jpg'
            />
            <h4>Анна К.</h4>
            <h6>Организатор мероприятий</h6>
            <p>
              Брала в аренду проектор и экран для корпоративного тренинга. Очень выручили – оборудование привезли вовремя, все настроили на месте. Качество изображения отличное, звук чистый. Цены приятно удивили, а сотрудники подсказали, как лучше подключить технику. Теперь только к вам!
            </p>
          </li>
          <li>
            <img
              src='https://photo5.wambacdn.net/71/81/97/1748791817/2001311154_huge.jpg?hash=m7cddFgiVQCWp1YwAhC2gA&expires=64060578000&updated=1697851878'
            />
            <h4>Игорсь С.</h4>
          ...
          <li>
            <img
              src='https://avatars.mds.yandex.net/i?id=5adc2486e781ec61b6c361a50d81c5db_l-8878159-images-thumbs&n=13'
            />
            <h4>Елена М.</h4>
            <h6>Менеджер по маркетингу</h6>
            <p>
              Заказывали колонки и проектор для презентации нового продукта. Понравилось, что техника в отличном состоянии, все работает без сбоев. Доставка точно в срок, а сотрудники помогли разобраться с настройками. Сотрудничаем уже второй раз – надежная компания!
            </p>
          </li>
          <li className='advice'>
          ...
          <li>
            <img
              src='https://avatars.dzeninfra.ru/get-zen_doc/4872899/pub_6380b7f6ec3c5c380e49ca45_6380b7f9b6162b56f3ce93d1/scale_1200'
            />
            <h4>Дмитрий П.</h4>
            <h6>Преподователь</h6>
            <p>
              Брал проектор для лекции в университете. Качество картинки на высоте, даже в большом зале все было видно. Удобно, что аренда недорогая, а оборудование можно взять на сутки. Обслуживание вежливое, все объяснили. Обязательно вернусь снова.
            </p>
          </li>

          <li>
            <img
              src='https://i.pinimg.com/736x/77/23/24/7723244cf1e985ece7c35ba78cc4b90e.jpg'
            />
            <h4>Ольга В.</h4>
            <h6>Свадебный организатор</h6>
            <p>“Арендовали проектор и колонки для свадьбы на открытом воздухе. Техника не подвела – видео показывали на большом экране, звук был громким и чистым. Ребята из компании подсказали, как лучше расположить оборудование. Клиенты в восторге, я тоже. Спасибо за профессионализм!
            </p>
          </li>
        </div>
